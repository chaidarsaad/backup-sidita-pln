...
class BappPolicy
{
    ...
    {
        return $user->can('delete_any_bapp');
    }
     ...
     */
    public function replicate(User $user, Bapp $bapp): bool
    {
