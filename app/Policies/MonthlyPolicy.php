...
class MonthlyPolicy
{
    ...
    {
        return $user->can('view_any_monthly');
    }
    ...
    {
        return $user->can('create_monthly');
    }
    ...
    {
        return $user->can('update_monthly');
    }
    ...
    {
        return $user->can('delete_monthly');
    }
    ...
    {
        return $user->can('delete_any_monthly');
    }
     ...
     */
    public function replicate(User $user, Monthly $monthly): bool
    {
