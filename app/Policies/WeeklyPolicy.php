...
class WeeklyPolicy
{
    ...
    {
        return $user->can('view_any_weekly');
    }
    ...
    {
        return $user->can('delete_any_weekly');
    }
     ...
     */
    public function replicate(User $user, Weekly $weekly): bool
    {
